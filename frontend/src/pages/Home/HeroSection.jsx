...
const AnimatedUiElement = ({ className, delay, floatDuration }) => (
    <motion.div
        ...
        animate={{ y: [0, -10, 0] }}
        style={{ transition: `transform ${floatDuration}s ease-in-out infinite` }}
        ...
        <section className="relative min-h-screen flex items-center px-6 overflow-hidden">
            <div className="absolute inset-0 z-0">
                ...
                <motion.div initial="hidden" animate="visible" variants={{ visible: { transition: { staggerChildren: 0.2 } } }}>
                    <AnimatedUiElement className="w-1/3 h-1/4 top-[15%] left-[10%]" delay={0.1} floatDuration={15} />
                    <AnimatedUiElement className="w-1/4 h-1/3 top-[50%] left-[25%]" delay={0.3} floatDuration={18} />
                    <AnimatedUiElement className="w-1/5 h-1/5 top-[20%] right-[15%]" delay={0.2} floatDuration={12} />
                    <AnimatedUiElement className="w-1/2 h-1/4 bottom-[15%] right-[10%]" delay={0.4} floatDuration={16} />
                </motion.div>
            </div>
